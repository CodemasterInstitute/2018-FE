$(document)
    .ready(function () {
        ...
        $('.lightboxTrigger').click((e) => {
            ...
            let slideNum = $('.lightboxTrigger').index(this);
            ...
            if ($('#lightbox').length > 0) {
                ...
                $('#imageSet')
                    .find('.lightboxTrigger')
                    .each(function () {
                        var $href = $(this).attr('href');
                        $('#slideshow').append('<img src="' + $href + '">');
                    });
        ...
        $('body').on('click', '.slide-nav', function (e) {
            ...
            // prevent default click event, and prevent event bubbling to prevent lightbox
            // from closing
            e.preventDefault();
            e.stopPropagation();
